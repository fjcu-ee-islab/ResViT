...
from utils2 import GradCAM, show_cam_on_image, center_crop_img
...
def main():
    ...
    # load image
    img_path0 = "mildmoderate.jpg"
    img_path1 = "normal.jpg"
    img_path2 = "severe.jpg"
    ...
    target_category = 0  # 0:mildmoderate 1:normal 2:severe
